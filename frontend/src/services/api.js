...
export const api = {
  ...
  voting: {
     ...
     * Required: { user_email, time_slot_indexes: [0, 1] }
     ...
     * Returns: { success: true, votes_by_user: {...}, votes_by_time_slot: {...}, 
     *           popular_time_slots: [...], total_votes: number, total_participants: number }
     */
